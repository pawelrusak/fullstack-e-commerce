      ...
      expect(color).toMatchInlineSnapshot(`
        {
          ...
          "onPrimaryDisabled": "hsl(0, 0%, 70%)",
          "onSecondary": "hsl(0, 0%, 100%)",
          "onSecondaryDisabled": "hsl(0, 0%, 70%)",
